...
var SelectFeat = React.createClass({
	...
	return(
		...
		<a href="#" onClick={this.handleDeleteFeat}>Delete Zone</a>
...
var Zone = React.createClass({
	...
	return(
		...
		{Object.keys(feats).map(function (key){
		    return(<Feat data={feats[key]} dataName={key}/>);
		})}
	    </div>
	);
    }
